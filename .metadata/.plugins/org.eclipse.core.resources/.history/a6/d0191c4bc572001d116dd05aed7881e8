...
<body>
	...
	<FORM method=post name=search action="shop_list.jsp">
		<TABLE border=0 width=95%>
			<TR>
				<TH align=rigth><FONT size=-1>상품명으로 찾기</FONT> <INPUT type=text
					name=pname> <INPUT type=submit value="검색"></TH>
			</TR>
			<TR>
				<TH><FONT size=-1> [<A href="/Shop/main.html">메인으로</A>]
						<A href="shop_list.jsp?cat=11">가구</A> <A
						href="shop_list.jsp?cat=22">전기/전자</A> <A
